...
const salesReport = document.querySelector(".car_sales");

salesByWeek.forEach(sale => {
    salesReport.innerHTML += `
    <h3>${sale.sales_agent.first_name} ${sale.sales_agent.last_name}</h3>
    `;
    ...
    salesReport.innerHTML += `
    <p class="profit"><strong>Profit: $${sale.gross_profit}</strong></p>
    `;
});
